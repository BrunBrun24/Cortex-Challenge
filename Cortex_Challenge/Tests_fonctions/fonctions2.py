...
def verifier_obstacle(defis: dict, ligne: int, colonne: int, direction: str) -> str:
    ...
    correspondances:dict = {("/","haut"): "droite", ("/","bas"): "gauche", ("/","droite"): "haut", ("/","gauche"): "bas",
...
def manquant2(defis: dict) -> int or None:
    ...
    """
    list_numbers_color1:list = []  # Utilisation d'un ensemble pour stocker les nombres de couleur 1
    list_numbers_color2:list = []  # Utilisation d'un ensemble pour stocker les nombres de couleur 2

    # Permet de récupérer une couleur disponible et de les mettre dans "list_color"
    couleur:str = defis["numbers"][0][-1]
...
def raisonnement2(defis: dict) -> str or None:
    ...
    """
    drawing:list = defis["drawing"]
    pieces:dict = defis["pieces"]
    ...
    new_drawing:list = [ligne[decalage:] for ligne in drawing if "" in ligne]
    ...
    finish_drawing:list = [ligne[decalage_new_drawing:] for ligne in new_drawing if "" in ligne]
